NAME "LUTFA NUR KHASANAH" ;NAMA PROGRAM
...
;VARIABEL
PSN1    DB "=============================================================",13,10
        DB "=                     Selamat Datang di                     =",13,10
        DB "=                                                           =",13,10
        DB "=            PEMROGRAMAN SEDERHANA KONVERSI SUHU            =",13,10
        DB "=      SKALA CELSIUS KE FAHRENHEIT, KELVIN, DAN RHEAMUR     =",13,10
        DB "=                                                           =",13,10
        DB "=                                                           =",13,10
        DB "=                        DIBUAT OLEH                        =",13,10
        DB "=                LUTFA NUR KHASANAH 2200018402              =",13,10
        DB "=                                                           =",13,10        
        DB "=============================================================",13,10
        DB "                                                             ",13,10
...
PSN6    DB 13,10,13,10,"Terima kasih telah menggunakan program Lutfa..."
        DB 13,10,13,10,"Tekan apa saja untuk keluar $"
CEL     DW ?
KEL     DW ?
RHE     DW ?
FAH     DW ?
